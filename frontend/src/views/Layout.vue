  ...
  <el-container class="layout-container">
    <el-aside width="200px" class="sidebar">
      ...
      <el-menu :default-active="activeMenu" class="menu" mode="vertical" :router="true">
        ...
        <!-- 临床用药：ADMIN、DOCTOR、PHARMACIST 可见 -->
        <el-sub-menu index="clinical" v-if="['ADMIN', 'DOCTOR', 'PHARMACIST'].includes(userRole)">
          <template #title>
        ...
        <!-- 特殊药品：ADMIN、SPECIAL_PHARMACIST 可见 -->
