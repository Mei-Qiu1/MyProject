    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/drugs/**").hasAnyAuthority("ADMIN", "PHARMACIST", "PURCHASER")
                .requestMatchers("/purchase/**").hasAnyAuthority("ADMIN", "PURCHASER")
                ...
                .requestMatchers("/special/**").hasAnyAuthority("ADMIN", "SPECIAL_PHARMACIST")
